---
title: "인앱 팝업 이벤트 리스너"
description: "노티플라이 SDK에서 인앱 팝업 이벤트를 감지하고 처리하는 방법을 안내합니다."
---
...
<Tabs>
  ...
  <Tab title="Flutter">
    `NotiflyPlugin.inAppEvents` 스트림을 통해 인앱 팝업 이벤트를 구독할 수 있습니다. 각 이벤트는 `InAppMessageEvent` 객체로 전달되며, 다음과 같은 속성을 포함합니다:
