---
title: “노티플라이 에이전트 스킬”
description: “노티플라이 에이전트 스킬 패키지의 구성과 설치 방법을 소개합니다.”
---

이 문서에서는 **노티플라이 에이전트 스킬** 패키지 모음을 소개합니다.
AI 코딩 에이전트를 위한 스킬 모음으로, 에이전트의 기능을 확장하는 패키지화된
인스트럭션과 스크립트입니다.
...
iOS, Android, Flutter, React Native 프로젝트에 노티플라이 모바일 SDK를 통합하고
노티플라이 MCP 서버를 함께 구성해 주는 스킬입니다.
...
스킬은 설치 후 자동으로 사용 가능합니다. 에이전트가 관련 작업을 감지하면 해당
스킬을 활용합니다.
...
버그 제보, 기능 제안 및 직접 기여해 주시는 것을 언제나 환영합니다. 의견이나 개선
사항이 있다면 GitHub 이슈를 등록하거나 Pull Request를 열어주세요.

- GitHub repository: [notifly-tech/skills](https://github.com/notifly-tech/skills)
