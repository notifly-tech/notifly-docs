---
title: "노티플라이 에이전트 스킬"
description: "노티플라이 에이전트 스킬 패키지의 구성과 설치 방법, 지원 클라이언트를 소개합니다."
---
...
| Codex CLI      | `--client codex`                       | `.codex/skills/`   |
...
AI의 비결정적 특성으로 인해 이러한 스킬이 때때로 실패하거나 의도한 대로 동작하지 않을 수 있습니다. 스킬이 수행하는 모든 작업은 항상 주의 깊게 검토하고 확인해 주시기 바랍니다.
...
- 패키지 및 릴리스 노트: [npm에서 확인](https://www.npmjs.com/package/notifly-agent-skills)
