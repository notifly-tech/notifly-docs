...
<AccordionGroup>
  ...
  <Accordion title="코호트 동기화를 시도했으나 노티플라이에서 확인이 안 됩니다.">
    코호트를 연동하실 때 첫 연동 시에는 약 20~30분 수준의 딜레이가 발생할 수 있습니다. 30분 동안 기다려보신 뒤 연동 처리가 되지 않으면 노티플라이 전용 슬랙 채널 혹은 contact@notifly.tech로 문의 주시기 바랍니다.
  </Accordion>
</AccordionGroup>